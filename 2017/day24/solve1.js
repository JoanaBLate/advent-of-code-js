...
// solving the puzzle takes (my computer) 0.715s
...
function main() {
    ...
    console.log("the strength of the strongest bridge is", findStrongest())
}  
...
function findStrongest() {
    ...
    for (const layer of layers) {
        ...
        const strength = getLayerStrength(layer)
...
function getLayerStrength(layer) {
