...
get a [white Christmas](https://adventofcode.com/2015/day/1) after all.

The weather machine beeps! On the console of the machine is a copy protection
message asking you to
[enter a code from the instruction manual][copy-protection]. Apparently, it
...
This process repeats until the [infinite paper is covered][cantor-diag]. So,
...
[copy-protection]: https://en.wikipedia.org/wiki/Copy_protection#Early_video_games
[cantor-diag]: https://en.wikipedia.org/wiki/Cantor's_diagonal_argument
