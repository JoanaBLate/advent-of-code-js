// solution for https://adventofcode.com/2025/day/5 part 1
...
function main() {
    ...
    for (const rawLine of availablePartLines) { checkNumber(parseInt(rawLine)) }
...
function checkNumber(number) {
    ...
    for (const range of allRanges) {
        ...
        if (number < range.begin) { continue }
        if (number > range.end)   { continue }
